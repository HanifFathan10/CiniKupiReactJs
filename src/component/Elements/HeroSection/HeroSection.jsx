...
const HeroSection = () => {
  ...
  return (
    <div
      className="w-full min-h-screen flex items-center text-white px-8 py-10 bg-center"
      style={bgImageStyle}
    >
      <div className="md:ml-10">
        <div className="max-w-xs md:max-w-sm md:ml-0 justify-center">
          <h2 className="text-sm md:text-[14px] italic text-zinc-300 uppercase font-semibold">
