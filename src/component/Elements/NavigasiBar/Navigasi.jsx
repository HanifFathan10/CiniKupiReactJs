...
const Navigasi = () => {
  ...
  return (
    <>
      ...
      <ul
        className={`md:flex md:items-center bg-slate-500 max-w-[140px] text-sm md:text-md md:pb-0 pb-2 absolute md:max-w-full md:static md:z-auto right-4 w-full md:w-auto md:bg-transparent rounded-lg md:pl-0 pl-6 transition-all duration-700 ease-in-out ${
