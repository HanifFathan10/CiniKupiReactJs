...
const ContactForm = () => {
  return (
    <footer className="bg-neutral-100 text-center dark:bg-neutral-600 lg:text-left z-[2]">
      ...
      <div className="container-fluid p-6 text-neutral-200">
        <div className="grid gap-4 sm:grid-cols-2 justify-center">
          ...
          <div className="flex justify-center gap-5 md:gap-16 mt-5">
            {/* Product */}
            <FooterList title="Product" item={<ListItems classnameLi="mb-4 uppercase text-start underline-offset-2 rounded-lg hover:text-slate-500 cursor-pointer transition duration-500" classNameUl="text-start text-sm uppercase" />} />
            {/* Information */}
      ...
      <div className="p-2 text-center bg-neutral-700 text-neutral-200 text-[10px] md:text-[12px]">
        © 2023 Copyright :{" "}
        <a className="text-neutral-800 dark:text-neutral-400" href="https://instagram.com/haniffthn__">
          Haniep Fathan Riziq
        </a>
      </div>
    </footer>
