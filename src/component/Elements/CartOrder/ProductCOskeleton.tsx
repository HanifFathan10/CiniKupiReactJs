  ...
  return (
    <section className="bg-primary grid min-h-screen w-full grid-cols-1 items-center shadow-md shadow-gray-700 md:justify-center">
      <div className="mt-28 grid-cols-1 items-center justify-center gap-3 md:flex md:grid-cols-2">
        ...
        <div className="mt-10 flex h-full w-full flex-col justify-center gap-y-3 text-white max-md:items-center md:mt-0">
          <Skeleton width={60} height={8} />
          <Skeleton width={40} height={5} />
        </div>
      </div>
      <div className="flex w-full flex-col justify-center bg-[#1e3932] px-2 py-6 text-white md:mt-10 md:items-center">
