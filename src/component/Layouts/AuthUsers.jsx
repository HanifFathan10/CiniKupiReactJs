...
const AuthUsers = ({ children, type }) => {
  return (
    <section className="h-screen text-xs bg-[#ffffff]">
      <div className="gap-6 flex h-full flex-wrap items-center justify-center md:justify-evenly">
        <div className="shrink-0 mb-4 basis-auto md:max-w-xl">{type == "login" ? <img src="images/login.jpg" className="max-w-xs md:max-w-md" alt="Sample image" /> : <img src="images/register.jpg" className="max-w-xs md:max-w-sm" alt="Sample image" />}</div>
