...
const Sidebar = () => {
  ...
  return (
    <div className="absolute left-0 top-0 z-[9999] flex h-screen w-72 -translate-x-full flex-col justify-between overflow-y-hidden bg-black px-5 py-3 duration-300 ease-linear lg:static lg:translate-x-0">
      ...
      <ul className="flex flex-col gap-3">
        <li
          className={`rounded-md ${pathname === "/admin/users" ? "bg-neutral-900" : ""} p-3`}
        >
        ...
        <Accordion animation="linear" allowToggle>
          <AccordionItem border={"none"}>
            ...
            <AccordionPanel pb={4}>
              <li
                className={`rounded-md ${pathname === "/admin/menus/menu" ? "bg-neutral-900" : ""} p-3`}
              >
                <Link
                  to="/admin/menus/menu"
              ...
              <li
                className={`rounded-md ${pathname === "/admin/menus/product" ? "bg-neutral-900" : ""} p-3`}
              >
                <Link
