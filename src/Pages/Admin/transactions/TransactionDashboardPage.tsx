          ...
          <div>
            <div className="flex flex-col items-center justify-between space-y-3 px-1 py-3 md:flex-row md:space-x-4 md:space-y-0">
              ...
              <Datepicker
                ...
                toggleClassName="absolute bg-dark rounded-r-lg text-white right-0 h-full px-3 text-gray-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed"
                i18n="id"
                value={date}
                onChange={handleDate}
                showShortcuts={true}
