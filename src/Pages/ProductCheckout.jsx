              ...
              <div className="md:w-4/5">
                ...
                <div>
                  {!images.fat && !images.calories && !images.sugar ? (
                    ...
                    <h3 className="text-xs font-semibold">
                      {images.calories} Calories, {images.sugar}g sugar,{" "}
                      {images.fat}g fat
                    </h3>
                  )}
                </div>
                <div className="flex w-full justify-end">
                  <Link
                    ...
                    className="bg-green py-3 mt-10 px-5 md:py-6 md:px-8 rounded-full font-semibold flex shadow-xl hover:bg-[#4abd93] focus:ring-4 focus:ring-emerald-500"
                  >
                    <svg
